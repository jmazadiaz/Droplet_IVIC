...
function I4 = LPFButterw(I,D,n,show)
...
%I=rgb2gray(imread('D:\Droplets Video\agua\48\AVI\IMG\img-A48-1\f001.jpg'));
    ...
    H_but = 1 ./ (1 + (dist ./ D) .^(2 * n));                                   % Creamos la base del filtro, arreglo de zeros del tamaño de la imagen.
...
if show == true                                                                 % En caso de visaulizar el resultado
    ...
    subplot(2,3,6), imshow(fftshift(H_but)), title('Butterworth LPfilter');
