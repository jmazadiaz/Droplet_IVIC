...
%%%%           Por ahora solo binarizar� todo debajo de 70 es cero                      %%%%
...
%%%%    Parte de separaci�n de las figuras en blanco
...
%%%%    Calcula el centroide y el radio de un �rea data en BW   %%%% 
