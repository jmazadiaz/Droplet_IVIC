...
%%            MIDE EL ESPARCIMIENTO DE LA GOTA (Correcci�n proyectiva) 169 - 191
...
%         c_bw_=binarizacion(c2_img_, T_bw_, inv_);
        ...
        c_img = {c2_img1_,c2_img2_,c2_img3_};                                   % Estructura para copiar l�neas
        %%
        

        c_cc_=bwconncomp(c_bw1_, nun_cc_);                                      % Busqueda de formas conectadas

    %        No es necesaria para el FOR  {Los elementos m�s grandes segun
    %        su lista de pixel
