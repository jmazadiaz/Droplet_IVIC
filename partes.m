...
vectAi_ = [70,1;150,50];
vectAe_ = [69,95;190,125]; % Recuadro Inferior izquierdo
vectBi_= [70,1;186,36]; % Recuadro superior central
...
if gota_ == 1
    ...
    %               title(strcat('imagen A B C: correlacion A-B:',num2str(cab_),'   ;      Correlacion A-C:',num2str(cac_),'   <-->  ',num2str(cab_-cac_)))
        ...
        file_archivo_ = strcat('indi_',files_(h_).name)
...
%%        
        file_archivo_ = strcat('ind_',files_(h_).name)
