...
%       D =  Cutoff 
%       n = orden
%       a = Valor de enfasis >= 0
%       b = valor de enfasis > a
...
function I4 = HPFButterwE(I,D,n,a,b,show)
...
%I=rgb2gray(imread('D:\Droplets Video\agua\48\AVI\IMG\img-A48-1\f001.jpg'));
    ...
    DFT_filt_gau = H_but_hfe .* I_dft;                                              % Operamos, cambian a cero todo lo que esta fuera del radio
...
if show == true                                                                 % En caso de visaulizar el resultado
    ...
    subplot(2,3,6), imshow(fftshift(H_but)), title('Butterworth HPfilter emph');
