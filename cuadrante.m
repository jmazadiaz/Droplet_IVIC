...
%          Los elementos m�s grandes segun su lista de pixel > Y               %

      [s2max, s2maxpos]=objectMaxSize(cc,T_O_);                             % Arriba T_O_

      bw1 = object(bw_,cc.PixelIdxList{s2maxpos(1)});

      [mm2Xpx,mmXpx,Tperimeter] = area(bw1,a_);                             % calcula la relaci�n pixel mm target
